    ...
    const BookingSearch = () => {
        if(atBookingsPage) return (
            <div className={"BookingSearch"}>
                <span className='bookingsHeadline'>
                    <h1>My Bookings</h1></span>
        ...
        <nav className={`${backColor}`}>
            ...
            <div className='mainNav'>
                ...
                <div className='navMenuButton'>
                    ...
                    <button className='whiteButton inheritBackground' onClick={handleMenuClick}>
                    <img src="hamburger.svg" alt="Menu" className="menu-icon" />
                    </button>
